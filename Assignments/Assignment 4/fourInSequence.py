# Ashlyn Croft             17Jul25
# Assignent 4
# We're... rounding out? Completing? Debugging?
# We're filling in anything needed to make this a functional game of connect 4
...
def main():
    ...
    while running:
        ...
        if choice == "p":
            ...
            print("- One player game has the user play against the computer.")
            print("- Two player game has two users play against one another.")
            ...
            print("- The game ends when one player has... FOUR IN SEQUENCE! / AKA Connect 4")
            pass
        elif choice == "q":
            running = False
            print("Goodbye!")
